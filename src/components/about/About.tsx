  ...
  return (
    ...
    >
      <div className="flex h-full w-full items-center justify-center">
        <div className="h-[450px] w-[500px] rounded-2xl border-4 border-teal-300/50 bg-blue-100">
          <div className="flex w-full items-center justify-between gap-2 border-b-3 border-teal-300/50 px-3 py-2">
            ...
            <div className="flex space-x-2">
              <div className="flex h-[20px] w-[20px] items-center justify-center border-3 border-teal-300/50">
                <div className="h-[10px] w-[10px] border-3 border-teal-300/50"></div>
              </div>
              <div className="flex h-[20px] w-[20px] items-center justify-center border-3 border-teal-300/50">
                <div className="relative h-[12px] w-[12px] translate-y-[5px]">
                  <div className="absolute h-[2px] w-full rotate-45 bg-teal-300/50"></div>
                  <div className="absolute h-[2px] w-full -rotate-45 bg-teal-300/50"></div>
                </div>
              </div>
            </div>
      ...
      <div className="flex h-full w-full flex-col items-center justify-center">
        ...
        <div className="w-[500px] divide-y-3 divide-teal-300/50 rounded-xl border-4 border-teal-300/50 bg-blue-100 text-xl text-gray-700">
